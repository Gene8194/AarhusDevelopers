...
[assembly:ModelsBuilderAssembly(PureLive = true, SourceHash = "aa2cf1dbfc31a8d0")]
...
#pragma warning restore 0109
	...
	/// <summary>Contuct Us</summary>
	[PublishedContentModel("contuctUs")]
	public partial class ContuctUs : Master
	{
#pragma warning disable 0109 // new is redundant
		public new const string ModelTypeAlias = "contuctUs";
		public new const PublishedItemType ModelItemType = PublishedItemType.Content;
#pragma warning restore 0109

		public ContuctUs(IPublishedContent content)
			: base(content)
		{ }
...
#pragma warning restore 0109
		...
		public static PublishedPropertyType GetModelPropertyType<TValue>(Expression<Func<ContuctUs, TValue>> selector)
		{
			return PublishedContentModelUtility.GetModelPropertyType(GetModelContentType(), selector);
		}
	}
